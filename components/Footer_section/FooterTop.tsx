...
const data: ContactItemData[] = [
  ...
  {
    title: "Email Us",
    subtitle: "asifmdasifchy@gail.com",
    icon: (
...
const FooterTop = () => {
  return (
    <div className='grid grid-cols-2 lg:grid-cols-4 gap-8 border-b '>
      {data?.map((item, index) => (
        <div key={index} className='flex items-center gap-3 hover:bg-gray-50 p-4 transition-colors group hoverEffect'>
          {item?.icon}
          <div>
