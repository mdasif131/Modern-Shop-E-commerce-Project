  ...
  return (
    <div className="py-16 md:py-0 bg-shop-light-pink rounded-lg px-10 lg:px-24 flex items-center justify-between">
      <div className='space-y-5'>
        ...
        <Link href={'/shop'} className="text-white/90 bg-shop-dark-green/90 px-5 py-2 rounded-md text-sm font-semibold hover:text-white hover:bg-shop-dark-green hoverEffect">
          Buy Now
        </Link>
      </div>
      <div className='pt-4'>
